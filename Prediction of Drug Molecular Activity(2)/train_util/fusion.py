...
class History(object):
    ...
    def correctness_update(self, data_idx, correctness, confidence):
        ...
        self.correctness[data_idx] =self.correctness[data_idx]+correctness.numpy()[:, np.newaxis]
...
def rank_loss(confidence, idx, history):
    ...
    return ranking_loss
def model_forward(model,lossfn1,lossfn2,input0,input1,input2,tgt,idx,d1_history=None,d3_history=None,gram_history=None,mode="train"):
